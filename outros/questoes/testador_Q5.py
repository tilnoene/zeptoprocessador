...
for i in range(0, 10):
    ...
    instrucoes = ['addi R1,R0,0,0', f'addi R2,R0,R0,{X}', f'addi R3,R0,R0,{Y}', 'bles R2,R0,4', 'subi R2,R2,R3,0', 'addi R1,R1,R0,1', 'beq R0,R0,-3', 'bles R0,R2,2', 'subi R1,R1,R0,1', 'beq R1,R1,0']
    contador = 0
